...
// //   newArray.unshift(typeof freinds[i]);
// // }

// // for (let i = 0; i < freinds.length; i++) {
// //   newArray.push(typeof freinds[i]);
// // }
// // for (let i = 0; i < newArray.length; i++) {
// //   console.log(newArray[i], typeof freinds[i]);
// // }

// // const birthYear = [1997, 1996, 1995, 1994, 1993, 1992];
// // const ages = [];
...
// // for (let i = 0; i < freinds.length; i++) {
// //   if (typeof freinds[i] !== "boolean") break;
// //   console.log(freinds[i], typeof freinds[i]);
// // }
...
// //   console.log(freinds[i], typeof freinds[i], i);
// // }

// // for (let excercise = 1; excercise < 3; excercise++) {
// //   console.log(`-----Excersise${excercise}-----`);
...
// // while (dice !== 6) {
// //   console.log(`Keep rollong the dice, the number was ${dice}`);
// //   dice = Math.trunc(Math.random() * 6) + 1;
// //   if (dice == 6) console.log("we got the dice 6 and loop is exiting....");
// // }
...
// // // const calcTip = function (bills, tips) {
...
//     let bill = bills[i];
//     tips.push(tip);
//     let total_value = tip + bill;
//     totals.push(total_value);
//   }
